...
plot(sub_data$Date,
     ...
     type = "l",
     ylim = c(ymin,ymax))
points(sub_data$Date, as.numeric(sub_data$Sub_metering_2), col = "red", type = "l")
points(sub_data$Date, as.numeric(sub_data$Sub_metering_3), col = "blue", type = "l")

legend( par("usr")[2], par("usr")[4], yjust=1, xjust=1,
        c(colnames(sub_data)[6:8]),
        lwd=1, lty=1,
